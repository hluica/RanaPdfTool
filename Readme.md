...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>PDF 文件的输出位置。<br>如果传入的是文件路径，则生成对应的文件；                <br>如果传入的是目录路径，则在对应目录下生成与源文件夹同名的文件。</td>
            </tr>
            <tr>
                <td>--raw</td>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td>--raw</td>
                            <td>如果存在，则尝试将 PDF 中的非 JPEG 图像对象还原成它原本的格式。<br>如果不存在，则将 PDF 中的非 JPEG 图像对象以 95% 质量参数转换为 JPEG 对象，再输出为文件。</td>
                            </tr>
                        </tbody>
                    </table>
